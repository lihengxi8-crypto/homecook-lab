...
> 用理科生的方式学做中餐家常菜：**先懂原理，再练技法，最后才谈创新**。
...
| `ingredients.html` | **食材档案**：常见食材的特性、适用技法与注意点 |
...
- **数据驱动**：术语表、食材档案、菜库、工具、搜索索引集中在 `assets/js/data.js`，新增内容只改数据即可。

## 内容组件约定（写新内容时复用）

- 绿色「原理」框：`<div class="note science">` —— 讲机制、给理科生深挖。
